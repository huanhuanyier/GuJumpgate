(function attachMultiPageFlowCapabilities(root, factory) {
  ...
  const VALID_PANEL_MODES = Object.freeze(['local-cpa-json', LOCAL_CPA_JSON_STEP5_PANEL_MODE, LOCAL_CPA_JSON_NO_RT_PANEL_MODE, 'cpa', 'sub2api', 'codex2api']);
  ...
  const FLOW_CAPABILITIES = Object.freeze({
    openai: Object.freeze({
      ...
      supportsPlatformBinding: ['local-cpa-json', LOCAL_CPA_JSON_STEP5_PANEL_MODE, LOCAL_CPA_JSON_NO_RT_PANEL_MODE, 'cpa', 'sub2api', 'codex2api'],
  ...
  const PANEL_CAPABILITIES = Object.freeze({
    ...
    [LOCAL_CPA_JSON_STEP5_PANEL_MODE]: Object.freeze({
      supportsPhoneSignup: true,
      requiresPhoneSignupWarning: false,
    }),
