(function attachStepDefinitions(root, factory) {
  ...
  const PLUS_PAYPAL_SMS_OAUTH_PREFIX_STEP_DEFINITIONS = NORMAL_PREFIX_STEP_DEFINITIONS.slice(0, 7);
  ...
  const PLUS_PAYPAL_SMS_OAUTH_STEP_DEFINITIONS = createHostedCheckoutSteps(
    PLUS_PAYPAL_SMS_OAUTH_PREFIX_STEP_DEFINITIONS,
    8,
    80,
    SIGNUP_METHOD_PHONE
  );
